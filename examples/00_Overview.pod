...
=head1 Graph::Easy manual - Overview

=head2 Introduction

=begin graph

 [ Source ] - Parser -> [ Internal objects ]
 - Layouter -> [ Layout ]

 [ Layout ] - output as -> [ ASCII ]
 [ Layout ] - output as -> [ HTML ]
 [ Layout ] - output as -> [ Graphviz ]
 [ Layout ] - output as -> [ SVG ]
